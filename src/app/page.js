...
export default async function Home() {
  return (
    <div className="w-full min-h-screen flex flex-col items-center justify-center bg-[url('foodimg.jpg')] opacity-90 ">
      ...
      <div className="mt-10 flex items-center gap-2 px-6 py-4 bg-orange-600 rounded-md text-2xl text-white font-bold hover:bg-orange-700 transition-all duration-500 group">
